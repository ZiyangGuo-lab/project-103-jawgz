...
def sortByPostingDate(request):
	...
	return render(request, 'find/find_ride.html',
				  {'title': 'Profile', 'postings_list': getRelevantRides().order_by('-date')})
...
def sortByRidingDate(request):
	...
	if flagSearch:
		...
		return render(request, 'find/find_ride.html',
				  {'title': 'Profile', 'postings_list': ans})
	return render(request, 'find/find_ride.html',
				  {'title': 'Profile', 'postings_list': getRelevantRides().order_by('-riding_date')})
...
def sortByPrice(request):
	...
	return render(request, 'find/find_ride.html',
				  {'title': 'Profile', 'postings_list': getRelevantRides().order_by('price')})
