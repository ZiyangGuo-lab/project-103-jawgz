...
class ViewTest(TestCase):
	...
	def testFindView(self):
		...
		p1.save()
		p2 = Posting.objects.create(driver_name="Yuxin Wu", vehicle_model="Honda", location_to="Jersey City,NJ", location_from="Fairfax,VA",date=dt.now(),riding_date=dt.now(),price=1, driver_id="yw7vv", num_passengers=2)
		p2.save()
	...
	def testDateView(self):
		date=dateView()
		p1 = Posting.objects.create(driver_name="Yuxin Wu", vehicle_model="Honda", location_to="Charlottesville,VA", location_from="Fairfax,VA",date=dt.now(),riding_date="2019-10-23",price=20, driver_id="yw7vv", num_passengers=3)
		p1.save()
